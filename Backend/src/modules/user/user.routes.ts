...
export class UserRoutes extends BaseRouter<UserController, UserMiddlewares> {
  ...
  routes(path: string): void {
    ...
    this.router.get(`/${path}/:id`, (req, res, nex) => this.middleware.checkId(req, res, nex) , (req, res) => this.controller.getById(req, res));
    this.router.post(`/${path}/post`, (req, res, nex) => this.middleware.checkToken(req, res, nex), (req, res) => this.controller.post(req, res));
