...
function Login() {
  return (
    ...
    <div className="bg-gradient-to-b from-blue-900 to-transparent bg-fixed bg-repeat-x w-screen h-screen">
        <div className="relative login-container h-full flex flex-col justify-center items-start ml-6">
          ...
          <button
            type="submit"
            className="w-full h-12 rounded-md transform scale-x scale-y bg-blue-900 mt-5 ml-10 text-white font-bold"
          >
            Iniciar sesión
          </button>

          <a href="#" className="mt-5 ml-10 text-center w-full font-Roboto font-semibold text-blue-900">
          ...
          <p className="mt-8 ml-10 text-blue-900 font-Roboto font-semibold">
  Al iniciar sesión, estás aceptando nuestros <a href="#" style={{color: "#0B5ED7"}}>Términos y Condiciones</a> y nuestra política sobre <a href="#" style={{color: "#0B5ED7"}}>Protección de Datos</a>.
        ...
        <div className="absolute bottom-0 right-0 eduweb-img">
