...
const commissions = [
  {
    ...
    schedule: 'Lunes 10:00 a 12:00',
    students: [
      { id: 1, firstName: 'Juan', surname: 'Perez', dni: '12345678' },
      { id: 2, firstName: 'Maria', surname: 'Gomez', dni: '12345678' },
      { id: 3, firstName: 'Pedro', surname: 'Pascal', dni: '12345678' },
    ],
    subjects: [{ id: 1, name: 'Matematica', gradId: 1, commissionId: 1 }],
    grads: [
      {
        id: 1,
        ...
        description:
          'El perfil profesional del Bachillerato Técnico en Informática pretende una sólida formación técnica, ética y humanística que le permita proyectar las competencias para incorporar y desarrollar programas informáticos',
        commissionId: 1,
      },
    ],
  },
        ...
        <div className="w-full md:w-4/5 md:max-h-[70vh] md:overflow-y-scroll overscroll-contain">
          ...
          <form className="flex flex-col md:flex-row md:gap-5 bg-gray-200 py-10 px-8 rounded-lg">
            <div className="w-4/12">
              <div className="mb-5">
                ...
                <div className="flex gap-1.5 items-center mb-1">
                  ...
                  <label htmlFor={'passed'} className="text-body-sm">
                    Aprobado
                  </label>
                </div>
                <div className="flex gap-1.5 items-center mb-1">
                  <input type={'radio'} id={'failed'} name={'status'} value={'failed'} onChange={handleChange} />
                  <label htmlFor={'failed'} className="text-body-sm">
                    Desaprobado
                  </label>
                </div>
                <div className="flex gap-1.5 items-center">
                  <input
                    ...
                    checked={true}
                  />
                  <label htmlFor={'regular'} className="text-body-sm">
                    Alumno regular
                  </label>
                </div>
              </div>
            ...
            <div className="w-8/12">
              ...
              <textarea
                className="w-full h-96 border border-border focus:border-primary rounded-md px-3 py-2 text-body focus:outline-none"
...
//   const res = await fetch('http://localhost:3000/commissions?_embed=subjects&_embed=grads');
