    ...
    <div className="bg-blue-900 ">
      <div className="p-12">
        ...
        <div className="flex justify-between mt-10">
          <button className="w-[241px] h-[85px] rounded-[10px] bg-blue-100 mx-49">
            Botón 1
          </button>
          <button className="w-[241px] h-[85px] rounded-[10px] bg-blue-100 mx-49">
            Botón 2
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <h2 className=" font-bold text-white text-2xl leading-6 mt-14 mb-10">
              Alumnos
            </h2>
                ...
                >
                  ...
                  <div className="flex flex-col pt-4 pb-4">
                    ...
                    <p className="font-normal text-black text-sm leading-5">
                      DNI {Math.floor(Math.random() * 100000)}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div>
            ...
            <ul className="list-disc list-inside">
              <li>
                <a href="#">Enlace rápido 1</a>
              </li>
              <li>
                <a href="#">Enlace rápido 2</a>
              </li>
              <li>
                <a href="#">Enlace rápido 3</a>
              </li>
              <li>
                <a href="#">Enlace rápido 4</a>
              </li>
            </ul>
          </div>
        </div>
